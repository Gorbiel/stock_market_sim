...
public record AuditLogEntryResponse(
        @Schema(
                ...
                OperationType type,
        @Schema(description = "Wallet ID", example = "wallet-1") @JsonProperty("wallet_id") String walletId,
        @Schema(description = "Stock name", example = "stock1") @JsonProperty("stock_name") String stockName) {}
